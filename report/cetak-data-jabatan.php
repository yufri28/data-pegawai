...
if (isset($_GET['nip'])) {
    $nip = $_GET['nip'];
    $sql_tampil = "SELECT *, dj.nama AS nama_jabatan FROM data_jabatan dj JOIN data_pegawai dpg ON dj.id_pegawai=dpg.id_pegawai WHERE dpg.nip='$nip'";
} else {
    if (isset($_GET["st"])) {
        switch ($_GET['st']) {
            case 'ttp':
        ...
        $sql_tampil = "SELECT *, dj.nama AS nama_jabatan FROM data_jabatan dj JOIN data_pegawai dpg ON dj.id_pegawai=dpg.id_pegawai WHERE dpg.status='$st'";
    } else {
        $sql_tampil = "SELECT *, dj.nama AS nama_jabatan FROM data_jabatan dj JOIN data_pegawai dpg ON dj.id_pegawai=dpg.id_pegawai";
    }
}
...
?>
    ...
    echo "<center><h4><u>DATA JABATAN</u></h4></center>";
        ?>
        ...
        <table border="1" cellspacing="0" style="width: 100%; border-collapse: collapse; text-wrap:wrap;">
            <thead>
                <tr style="text-align: center;">
                    ...
                    <th style="padding: 15px;">Eselon</th>
