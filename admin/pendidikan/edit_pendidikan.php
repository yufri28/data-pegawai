    ...
    <form action="" method="post">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input required class="form-control" value="<?= $data_cek['tahun_lulus']??'-'; ?>" type="number"
                        placeholder="Tahun lulus" id="tahun_lulus" name="tahun_lulus" min="1900" max="2099" step="1">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Jurusan</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="<?= $data_cek['jurusan']??'-'; ?>" id="jurusan"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <select required id="pendidikan_terakhir" name="pendidikan_terakhir" class="form-control">
                        <option value="">- Pilih -</option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "SD" ? 'selected' : ''; ?> value="SD">SD
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "SMP" ? 'selected' : ''; ?> value="SMP">SMP
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "SMA" ? 'selected' : ''; ?> value="SMA">SMA
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "DI" ? 'selected' : ''; ?> value="DI">DI
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "DII" ? 'selected' : ''; ?> value="DII">DII
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "DIII" ? 'selected' : ''; ?> value="DIII">DIII
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "DIV" ? 'selected' : ''; ?> value="DIV">DIV
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "S1" ? 'selected' : ''; ?> value="S1">S1
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "S2" ? 'selected' : ''; ?> value="S2">S2
                        </option>
                        <option <?= $data_cek['pendidikan_terakhir'] == "S3" ? 'selected' : ''; ?> value="S3">S3
                        </option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" value="<?= $data_cek['lembaga_pendidikan']??'-'; ?>" class="form-control"
                        id="lembaga_pendidikan" name="lembaga_pendidikan" placeholder="Nama lembaga pendidikan"
                        required>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Kursus atau Diklat" name="kursus_diklat"
                            style="height: 100px"><?= $data_cek['kursus_diklat']??'-'; ?></textarea>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Pendidikan Perjenjangan" name="pend_perjenjangan"
                            style="height: 100px"><?= $data_cek['pend_perjenjangan']??'-'; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
